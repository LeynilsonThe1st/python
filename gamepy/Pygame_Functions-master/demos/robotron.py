...
class Player():
    def __init__(self):
        ...
        self.sprite = makeSprite("/Users/leynilson_harden/Dropbox/Programação/PycharmProjects/python/gamepy/Pygame_Functions-master/demos/images/smalllinks.gif",32)
...
class Projectile():
    def __init__(self, xpos, ypos, xspeed, yspeed, damage):
        ...
        self.sprite = makeSprite("/Users/leynilson_harden/Dropbox/Programação/PycharmProjects/python/gamepy/Pygame_Functions-master/demos/images/greendot.png")
        self.move()
        showSprite(self.sprite)
