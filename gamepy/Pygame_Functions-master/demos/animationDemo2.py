...
testSprite  = makeSprite("/Users/leynilson_harden/Dropbox/Programação/PycharmProjects/python/gamepy/Pygame_Functions-master/demos/images/links.gif", 32)  # links.gif contains 32 separate frames of animation.
